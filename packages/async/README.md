...
Check the real-world example in pooling example from [below story tests](https://www.reatom.dev/packages/async#story-test) ([src](https://github.com/artalar/reatom/blob/v3/packages/async/src/index.story.test.ts)).
