...
Also, `listResource` now has a `promiseAtom` that contains the last promise. You can use it with [useAtomPromise](https://www.reatom.dev/adapter/npm-react/#useatompromise) in a React application, for example.
