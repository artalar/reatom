...
> Do you want to see [the docs for React adapter](https://www.reatom.dev/adapter/npm-react) next?
...
> Read more in the [lifecycle guild](https://www.reatom.dev/guides/lifecycle).
