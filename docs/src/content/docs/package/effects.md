...
This API is a variation of "effect" / "useEffect" API of others libraries. For example, here is how it can be used with `reatomComponent` from [@reatom/npm-react](/package/npm-react/).
